...
#define ListBoxGetItemCount(hLB) \
	SendMessage(hLB, LB_GETCOUNT, (WPARAM) 0, (LPARAM) 0)
#define ListBoxAddString(hLB, pString) \
	SendMessage(hLB, LB_ADDSTRING, (WPARAM) 0, (LPARAM) pString)
#define ListBoxInsertString(hLB, index, pString) \
	SendMessage(hLB, LB_INSERTSTRING, (WPARAM) index, (LPARAM) pString)
#define ListBoxDeleteString(hLB, index) \
	SendMessage(hLB, LB_DELETESTRING, (WPARAM) index, (LPARAM) 0)
#define ListBoxResetContents(hLB) \
	SendMessage(hLB, LB_RESETCONTENT, (WPARAM) 0, (LPARAM) 0)
